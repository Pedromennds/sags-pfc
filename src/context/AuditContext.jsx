...
const registrosIniciais = [
  { id: 'log1', quando: new Date(Date.now() - 26 * 3600 * 1000).toISOString(), ator: 'Pedro Jorge', acao: 'aprovou', alvo: 'Aula de reposição de Estrutura de Dados', detalhe: 'Sala 109 · Bloco Didático I' },
